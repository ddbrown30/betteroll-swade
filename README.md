...
This module adds completely different rolls cards to the SWADE system that supports both more complex rolls and more automation.
...
In the [Wiki for this repository](https://github.com/ddbrown30/betteroll-swade/wiki) you will find detailed documentation concerning the critical elements and functionality of Better Rolls for SWADE.
